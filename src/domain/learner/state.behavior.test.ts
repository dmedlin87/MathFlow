...
describe('learner/state behavior', () => {
    ...
    describe('updateLearnerState', () => {
        ...
        it('should clamp mastery between 0.01 and 0.99', () => {
             ...
             const attempt = {
                 id: 'att_1', userId: 'u1', itemId: 'i1', skillId: 'test_skill', 
                 timestamp: FIXED_DATE.toISOString(), isCorrect: true, 
                 timeTakenMs: 100, attemptsCount: 1, hintsUsed: 0, errorTags: [] 
             };
        ...
        it('should initialize state for a new skill if missing', () => {
             ...
             const attempt = {
                 id: 'att_1', userId: 'u1', itemId: 'i1', skillId: 'new_skill', 
                 timestamp: FIXED_DATE.toISOString(), isCorrect: true, 
                 timeTakenMs: 100, attemptsCount: 1, hintsUsed: 0, errorTags: [] 
             };
