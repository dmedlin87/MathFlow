...
2.  **Tighten `state.test.ts` Assertions (High)**
    ...
    - **How:** In `clamps mastery...`, set the mastery probability to a value exceeding 0.99 (e.g., 1.5) before clamping, and verify it clamps to *exactly* `0.99` (or `MASTERY_CEILING`).
