...
export class ContentPipeline {
    constructor(
        ...
        private config: PipelineConfig = { maxAttempts: 3, requireDeterministicVerification: false }
    ) {}
    ...
    async run(difficulty: number): Promise<MathProblemItem | null> {
        ...
        while (attempts < this.config.maxAttempts) {
            ...
            let verificationResult = { passed: true, details: "Skipped", type: "none" };
            if (this.verifier) {
            ...
            if (isApproved) {
                ...
                candidate.meta.provenance = {
                    ...
                    verifier: {
                        type: verificationResult.type as any,
