import { OfflineGenerator, Critic, Judge, CriticResponse, JudegeVerdict } from '../base.js';
    ...
    async generate(difficulty: number): Promise<MathProblemItem> {
        ...
        return {
            ...
            meta: {
                ...
                verification_report: undefined as any,
                status: 'DRAFT'
            }
        };
    }
...
export class MockCritic implements Critic {
    ...
    async solve(problemContent: MathProblemItem['problem_content']): Promise<CriticResponse> {
        return {
            derivedSolution: "42",
            rubricScores: {
...
export class MockJudge implements Judge {
    ...
    async evaluate(generatorItem: MathProblemItem, criticResponse: CriticResponse): Promise<JudegeVerdict> {
